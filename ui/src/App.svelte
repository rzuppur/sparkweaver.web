...
<main>
  ...
  <div class="area-toolbar">
    <button type="button" aria-label="Edit node tree" title="Edit nodes" class:active={toolbarTab === "nodes"} onclick={() => toolbarTab = "nodes"}>
    ...
    <button type="button" aria-label="Run DMX simulation" title="Simulate" class:active={toolbarTab === "simulation"} onclick={() => toolbarTab = "simulation"}>
      <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px">
